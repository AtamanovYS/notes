- SQL
    ...
    - [Генератор простых чисел на T-SQL](prime_number_generator.sql) (https://infostart.ru/1c/articles/1581015)
- 1С
    - Запросы
        ...
        - [Генерация простых чисел запросом](1С/ГенерацияПростыхЧиселЗапросом.bsl) (https://infostart.ru/1c/articles/1581015/)
    - [Интерфейс для программного изменения форм](https://github.com/AtamanovYS/interface-for-developing-forms/blob/main/ИнтерфейсДляПрограммногоИзмененияФорм.bsl) (https://infostart.ru/1c/articles/1556681)
    ...
    - [Разность дат](1С/РазностьДат.bsl)
