- SQL
    ...
    - [Генератор простых чисел на T-SQL](prime_number_generator.sql)
- 1С
    - Запросы
    ...
    - [Интерфейс для программного изменения форм](https://github.com/AtamanovYS/interface-for-developing-forms/blob/main/ИнтерфейсДляПрограммногоИзмененияФорм.bsl)
